...
export default function NewAccessoryPage() {
  ...
  return (
    <div className="max-w-3xl">
      <LoadingOverlay isLoading={saving} message="Guardando Accesorio y Subiendo imágenes..." />
      <h1 className="text-2xl font-heading text-charcoal mb-8">Nuevo Accesorio</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <ImageUploader onUpload={files => setImages(prev => [...prev, ...files])} label="Subir imágenes" />
        ...
        <div className="flex gap-4 pt-4">
          <button type="submit" disabled={saving} className="btn-gold-filled disabled:opacity-50">
            {saving ? 'GUARDANDO...' : 'CREAR ACCESORIO'}
          </button>
