...
export default function EditAccessoryPage() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="text-2xl font-heading text-charcoal mb-8">Editar Accesorio</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          <div>
            <label className="block text-xs font-sans font-semibold tracking-wider text-charcoal uppercase mb-2">Precio</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="flex items-start gap-3 cursor-pointer p-3 border border-gray-200 rounded-lg hover:border-gold transition-colors">
              ...
              <div>
                ...
                <span className="text-[11px] font-sans text-body-gray">Hace el accesorio visible en el sitio web público. Sin publicar = Borrador (oculto).</span>
              </div>
            </label>
          </div>
        </div>
        ...
        <div className="flex gap-4 pt-4">
          ...
          <button type="button" onClick={() => router.back()} className="btn-gold">CANCELAR</button>
        </div>
      </form>
    </div>
  )
