                        ...
                        return (
                          ...
                          >
                            <Link href={`/dresses/${dress.slug}`}>
                              ...
                              <h3 className="font-heading text-2xl text-[#333] group-hover:text-[#f05f42] transition-colors font-light mb-1 truncate" style={{ fontVariantNumeric: 'lining-nums' }}>{dress.name}</h3>
                            </Link>
                          </motion.div>
                      )})}
                      {catDresses.length > 6 && (
                ...
                return (
                  ...
                  >
                    <Link href={`/dresses/${dress.slug}`}>
                      ...
                      <h3 className="font-heading text-lg text-[#333] group-hover:text-[#f05f42] transition-colors font-light mb-2 line-clamp-2" style={{ fontVariantNumeric: 'lining-nums' }}>{dress.name}</h3>
                    </Link>
                  </motion.div>
                );
              })}
